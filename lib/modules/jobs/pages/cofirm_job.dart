                  ...
                  children: [
                    ...
                    GestureDetector(
                        ...
                        onTap: ()async{
                          ...
                          JobAgreeResponse? model = await  _remoteApi.confirmJob(JobAgreedModel(jobId: widget.jobId,
                              jobStartDate: BlocProvider.of<PickupDateCubit>(context).getPickupDate(),
                              status: 'Confirm Start Date',
                              depositAmount: '600', jobEndDate: BlocProvider.of<PickupDateCubit2>(context).getPickupDate(),
