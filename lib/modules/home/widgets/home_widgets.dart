            ...
            Row(
             ...
             children: [
                   ...
                   children: [
                     Text( userModel.fullName,
                       ...
                       style:theme.textTheme.titleLarge!.copyWith(
                        color: CustomColors.primeColour, fontWeight: FontWeight.normal,
                     ...
                     Text(userModel.businessTradingDate.toString(),
                         style:theme.textTheme.titleMedium!.copyWith(
                             color: CustomColors.primeColour
                         )
                     ),
               ...
               SizedBox(
                 ...
                 width: 140,
                 child: Container(
                   child: Image.network('${userModel.filePath}/${userModel.logo}',
                   fit: BoxFit.fill,),
                   decoration: BoxDecoration(
                     borderRadius: BorderRadius.circular(10),
                ...
                SizedBox(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: CustomColors.greyButton, // set the border color here
        ...
        return GestureDetector(
          onTap: () async {
            switch(index){
              ...
              break;
              case 6:
              Navigator.push(context, MaterialPageRoute(builder: (context) => TradesPage()));
              break;
              case 7:
              Navigator.push(context, MaterialPageRoute(builder: (context) => ChecklistPage()));
              break;
              case 8:
              Navigator.push(context, MaterialPageRoute(builder: (context) => FAndIPage()));
              break;
              case 9:
              Navigator.push(context, MaterialPageRoute(builder: (context) => ReceiptsPage()));
              break;
              case 10:
              Navigator.push(context, MaterialPageRoute(builder: (context) => EssentialsPage()));
              break;
              case 11: 
              Navigator.push(context, MaterialPageRoute(builder: (context) => TrainingsPage()));
              break;
            }
          },
          child: Container(
