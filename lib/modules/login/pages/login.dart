    ...
    return Scaffold(
            ...
            child: Row(
              ...
              children: [
                SizedBox(
                  ...
                  width: 180,
                  child: longButton(
                      context, 'NEXT', CustomColors.blueButton),
                ),
              ],
            ),
          )),
      body: Stack(
        children:<Widget> [
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: textField(context, _username, 'Username', 390, 45),
                ),
                SizedBox(
          ...
          _isLoading? Center(child: SpinKitCircle(color: CustomColors.primeColour,
            size: 50.0,)): Container()
        ],
      ),
    );
