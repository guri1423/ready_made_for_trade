...
import 'package:ready_made_4_trade/modules/youtube/widgets/textList.dart';
import 'package:youtube_player_flutter/youtube_player_flutter.dart';

import '../../check_list/models/checklist_model.dart';
class videoPage extends StatefulWidget {
   GetChecklist? videolink,description;
  videoPage({Key? key,required this.videolink,required this.description}) : super(key: key);
...
/*  late YoutubePlayerController controller;
  ...
  Widget build(BuildContext context) {
    debugPrint(widget.description.toString());
