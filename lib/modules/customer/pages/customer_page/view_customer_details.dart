          ...
          child: Column(
            children: [
                  ...
                  Expanded(
                      child: GestureDetector(
                          ...
                          child: customisedButton(
                              ...
                              'EMAIL',
                              CustomColors.blueButton,
                              'assets/images/small_icons/001-email.png'))),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => AddJobsPage(
                                  customerId: widget.data.id.toString(),
                                )));
                  },
                  child: customisedButton(
                      context,
                      'START A NEW JOB',
                      CustomColors.blueButton,
                      'assets/images/small_icons/003-add.png')),
              SizedBox(
                height: 15,
              ),
              Text('JOBS',
              ...
              FutureBuilder<JobsModel?>(
                future: _remoteApi
                    .getJobsOnCustomerBasis(widget.data.id.toString()),
                builder:
                    (BuildContext context, AsyncSnapshot<JobsModel?> snapshot) {
